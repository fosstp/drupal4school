...
function d4s_bootstrap_form_system_theme_settings_alter(&$form, $form_state, $form_id = NULL) {
  ...
  $form['bootstrap'] = array(
    '#type' => 'vertical_tabs',
    '#attached' => array(
      'js'  => array(drupal_get_path('theme', 'd4s_bootstrap') . '/js/bootstrap.admin.js'),
    ),
    '#prefix' => '<h2><small>' . t('Drupal4School Accessibility Bootstrap Settings') . '</small></h2>',
    '#weight' => -10,
  );
  ...
  $form['general']['container']['bootstrap_fluid_container'] = array(
    ...
    '#description' => t('Use <code>.container-fluid</code> class. See <a href="!url" target="_blank">Fluid container</a>', array(
  ...
  $form['general']['buttons']['bootstrap_button_colorize'] = array(
    ...
    '#description' => t('Adds classes to buttons based on their text value. See: <a href="!bootstrap_url" target="_blank">Buttons</a> and <a href="!api_url" target="_blank">hook_bootstrap_colorize_text_alter()</a>', array(
      '!bootstrap_url' => 'http://getbootstrap.com/css/#buttons-options',
  ...
  // Accessibility Settings.
	...
	$form['mtt_settings']['Accessibility'] = array(
		'#type' => 'fieldset',
		'#title' => t('Accessibility Guide Brick'),
		'#collapsible' => TRUE,
		'#collapsed' => FALSE,
	);
	
  
	$form['mtt_settings']['Accessibility']['access_brick'] = array(
		'#type' => 'checkbox',
		'#title' => t('Show guide brick'),
		'#default_value' => theme_get_setting('access_brick','d4s_bootstrap'),
	  ...
	  $form['mtt_settings']['menu']['main_navigation'] = array(
		'#type' => 'textfield',
		'#title' => t('Accesskey for Navigation Menu'),
		'#default_value' => theme_get_setting('main_navigation','d4s_bootstrap'),
	...
	$form['mtt_settings']['header_block'] = array(
        '#type' => 'fieldset',
        '#title' => t('Header'),
        '#collapsible' => TRUE,
        '#collapsed' => TRUE,
	...
	$form['mtt_settings']['header_block']['header'] = array(
		'#type' => 'textfield',
		'#title' => t('Accesskey for Header Block'),
		'#default_value' => theme_get_setting('header','d4s_bootstrap'),
		'#description' => t('This block using access key Alt+h by default!'),
	  );	  
	  
	
	$form['mtt_settings']['sidebar'] = array(
        '#type' => 'fieldset',
        '#title' => t('Sidebar'),
        '#collapsible' => TRUE,
        '#collapsed' => TRUE,
	...
	$form['mtt_settings']['sidebar']['sidebar_first'] = array(
		'#type' => 'textfield',
		'#title' => t('Accesskey for First Sidebar'),
		'#default_value' => theme_get_setting('sidebar_first','d4s_bootstrap'),
		'#description' => t('This block using access key Alt+r by default!'),
	  );
	  
	$form['mtt_settings']['sidebar']['sidebar_second'] = array(
		'#type' => 'textfield',
		'#title' => t('Accesskey for Second Sidebar'),
		'#default_value' => theme_get_setting('sidebar_second','d4s_bootstrap'),
		'#description' => t('This block using access key Alt+s by default!'),
	  );
	
	
	$form['mtt_settings']['highlighted_block'] = array(
        '#type' => 'fieldset',
        '#title' => t('Highlighted'),
        '#collapsible' => TRUE,
        '#collapsed' => TRUE,
	  ...
	  $form['mtt_settings']['highlighted_block']['highlighted'] = array(
		'#type' => 'textfield',
		'#title' => t('Accesskey for Highlighted Block'),
		'#default_value' => theme_get_setting('highlighted','d4s_bootstrap'),
		'#description' => t('This block using access key Alt+i by default!'),
	  );
	  
	
	$form['mtt_settings']['content'] = array(
        '#type' => 'fieldset',
        '#title' => t('Content'),
        '#collapsible' => TRUE,
        '#collapsed' => TRUE,
	 ...
	 $form['mtt_settings']['content']['main_content'] = array(
		'#type' => 'textfield',
		'#title' => t('Accesskey for Main Content'),
		'#default_value' => theme_get_setting('main_content','d4s_bootstrap'),
		'#description' => t('This block using access key Alt+c by default!'),
	  );	  
	  
	  
	  
	$form['mtt_settings']['content']['help'] = array(
		'#type' => 'textfield',
		'#title' => t('Accesskey for Help Content'),
		'#default_value' => theme_get_setting('help','d4s_bootstrap'),
		'#description' => t('This block using access key Alt+p by default!'),
	  );


	$form['mtt_settings']['footer_block'] = array(
        '#type' => 'fieldset',
        '#title' => t('Footer'),
        '#collapsible' => TRUE,
        '#collapsed' => TRUE,
	...
	$form['mtt_settings']['footer_block']['footer'] = array(
		'#type' => 'textfield',
		'#title' => t('Accesskey for Footer block'),
		'#default_value' => theme_get_setting('footer','d4s_bootstrap'),
...
/*	$form['adaptive_menu'] = array(
	...
	$form['credits']['credits_display'] = array(
		...
		'#default_value' => theme_get_setting('credits_display','d4s_bootstrap'),
	  );
