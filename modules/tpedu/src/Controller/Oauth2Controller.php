    ...
    public function notice(Request $request) {
        return array(
            ...
            <tr><td style="text-align:left;width:100%;font-family:標楷體;font-size:16px">
                ...
                當事人可連絡本校資訊組進行申請，前述之申請，應填具申請文件，並由本人親自申請，本校得向您請求提出可資確認身分之證明文件。若委託他人代為申請者，應出具委任書，並提供本人及代理人之身分證明文件。<span style=font-weight: bold;">您若拒絕提供上述個資或是要求刪除或停止蒐集、處理或利用時，除將無法登入本網站繼續使用各項需辨識身分之服務外，也將影響各項教育獎助、社會福利措施之後續通知與申辦。</span></p>
                </td></tr>
